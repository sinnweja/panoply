...
xdrugTable <- xtable(drugTable[,c("Drug","Cancer.Genes","Network.Genes","N.Pathways","Network.pval","ZSim.pval","PScore","RF.Score")], display=c("d","s","s","s","d","f","f","f","f"),caption="Cancer Drug Table",digits=4)
